...
if( isset($_POST['book-it']) ) {
	...
	$query = "INSERT INTO `enrolled_courses`(`userId`,`courseId`) VALUES($userId, $courseId)";
	   ...
	   <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12  mt-4 mb-4">	
				...
				<div class="card">
					...
					<div class="card-footer">
						...
						<form method="post">
						<input type="text" value="$row['userId']" hidden>
						<input type="text" value="$row['coursId']" hidden>
						<button type="submit" class="btn btn-success" name="book-it" placeholder="book it" style="width: 100%;"> Enroll </button>
						 </form>
					</div>
				</div>	
				</div>		
